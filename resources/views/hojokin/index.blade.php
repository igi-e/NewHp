...
<body>
    ...
    <div class="group-info">
        ...
        <p><img src="/img/syouene3.jpg" class="group-info-img1"></p>
            ...
            ・申請機器に対するデータ収集<br>
            ・申請書記入等に関する問合せ<br>
            また、申請代行を希望の場合、猪木酸素と関係のある申請業者をご紹介することも可能です。<br>
            ■ 補助金活用可能な設備<br>
            省エネに関する補助金は空調から照明からボイラー、コンプレッサー、そして場合によっては、溶解炉などあらゆる設備（生産設備含む）に対して活用が可能です。<br>あらゆる設備に補助金が使える可能性があります。<br>
            ■最近の省エネ補助金の傾向として抑える点は…<br>
            ・大型な施設投資の必要はありません。ＬＥＤや空調更新だけでも申請が可能です。<br>
