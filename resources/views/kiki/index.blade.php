...
<body>
    ...
    <div class="container">
        <div class="group-info">
            <h2 class="title">高圧ガスや溶接材料、機械、工具などの販売「機器・溶材部門」</h2>
            ...
            <div class="subtitle">機器・溶材部門 営業品目</div>
            <!-- <p><img src="/img/h-about-photo2.jpg" class="group-info-img2"></p> -->
            <table class="kiki_hinmoku-joudan">
                <tr>
                    <td><img class="gas" src=" \img\bonbe-2.jpg"></td>
                    <td>
                        <h4>各種医療用ガス・各種工業用ガス</h4>
                        <p>・医療で使用される吸入酸素、医療用炭酸ガス、亜酸化窒素など<br>・工業用で使用される酸素ガス、炭酸ガス、窒素、アルゴンガスなど<br>・その他、分析用ガス、食品用ガスなど各種取り扱っております。</p>
                    </td>
                </tr>
                <tr>
                    <td><img class="kikai" src="\img\bandoso.jpg"></td>
                    <td>
                        <h4>機械・工具</h4>
                ...
                <tr>
                    <td><img class="kougu" src="\img\kiki_kougu_1.jpg"></td>
                    <td>
                        <h4>溶接機・溶接材料</h4>
                ...
                <tr>
                    <td><img class="syuuri" src="\img\syuri_1.jpg"></td>
                    <td>
                        <h4>機器修理</h4>
                        <p>・天井クレーン、溶接機、各種電動工具などの修理</p>
                    </td>
                </tr>
                <tr>
                    <td><img class="kakou" src="\img\kakou_1.jpg"></td>
                    <td>
                        <h4>製作加工品</h4>
                        <p>・パレット、溝蓋、足場、パイプなど、溶接, 機械加工の製作物, 設備工事</p>
                    </td>
                </tr>
                <tr>
                    <td><img class="sonota" src="\img\syoukakiakua-1.jpg"></td><br>
                    <td>
                        <h4>その他</h4>
                        <p>・消火器の点検・詰め替え<br>・おいしい水（ボトルサーバー貸出）</p>
                    </td>
                </tr>
            </table>
            <p>＊上記は一例です。その他各種取扱商品がございますので、お気軽にお問い合わせください。</p>
        </div>
    </div>
