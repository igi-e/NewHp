...
<body>
    ...
    <div class="group_info">
        <h2>猪木酸素の省エネ事業</h2> <p><img src="/img/syouene3.jpg" class="group-info-img1"></p>
            <p>省エネをしたいと思っていても<br>「何をしていいのかわからない。」<br>「省エネするには大きな設備投資が必要でしょう？」<br>「たいしてコスト削減出来ないのでは？」<br>など一歩踏み出せずにいませんか？<br>• 出来るだけ既存設備を活かした省エネ・コスト削減の提案をします。<br>• 小さな投資で大きなコスト削減を目指した提案をします。<br>• 投資回収は３年を目指して提案をします。<br>• 電気だけでなくガス・油・水・エアーなどトータルな提案をします。<br>• 省エネだけでなく設備の延命化・作業環境・効率を上げる提案をします。<br><br>私どもは、これらの提案を環境企業ネットワークから選りすぐり提案することが出来ます。<br><br>何から始めれば良いのか分からないお客様には「猪木酸素の無料診断省エネ診断サービス」をスタートとしてご提案します。<br>すでに対策を実施しているお客様でも、新たな発見があると思います。ひとまず、猪木酸素の無料診断をされてはいかがでしょうか？<br>ご連絡お待ちしております。<br><br>もっと深く知りたい方は、エコレターもご覧ください。</p>
    ...
    <div class="ecoletter">
        ...
        <h3>お役立ち情報誌「省エネ通信」</h3>
        <p>猪木酸素の情報発信のツールとして「いぎさんそエコレター」を作成しました。御活用して頂けたら幸いです。
            <h3>■省エネ通信とは？</h3>
            <p>猪木酸素では、省エネや補助金、または法規制など、タイムリーでお得な情報を定期発信しています！とにかく事例中心の大好評情報です！<br>～掲載事例の一例～<br>・気化熱を活用した空調で空調コストを大幅削減！【気化熱利用給気システム】<br>・熱源に貼るだけで放熱を遮熱（抑制）する【特殊遮熱シート】<br>・熱源に貼るだけで放熱を遮熱（抑制）する【高性能遮熱塗料】<br>・窓ガラスに貼るだけ！空調の省エネに…【遮熱フィルム】</p>
        </p>
    </div>
