...
<body>
    ...
    <div class="group-info">
        ...
        「たいしてコスト削減出来ないのでは？」<br>
        など一歩踏み出せずにいませんか？<br>
        • 出来るだけ既存設備を活かした省エネ・コスト削減の提案をします。<br>
        • 小さな投資で大きなコスト削減を目指した提案をします。<br>
        • 投資回収は３年を目指して提案をします。<br>
        • 電気だけでなくガス・油・水・エアーなどトータルな提案をします。<br>
        • 省エネだけでなく設備の延命化・作業環境・効率を上げる提案をします。<br><br>
        私どもは、これらの提案を環境企業ネットワークから選りすぐり提案することが出来ます。<br><br>
        何から始めれば良いのか分からないお客様には「猪木酸素の無料診断省エネ診断サービス」をスタートとしてご提案します。<br>
        すでに対策を実施しているお客様でも、新たな発見があると思います。ひとまず、猪木酸素の無料診断をされてはいかがでしょうか？<br>
        ご連絡お待ちしております。<br><br>
        もっと深く知りたい方は、エコレターもご覧ください。</p>
    </div>

    <div class="ecoletter">
        <h2>いぎさんそエコレター</h2>
        <h3>お役立ち情報誌「省エネ通信」</h3>
        <p>猪木酸素の情報発信のツールとして「いぎさんそエコレター」を作成しました。御活用して頂けたら幸いです。</p>
        <h3>■省エネ通信とは？</h3>
